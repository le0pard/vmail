<script>
	...
	const genAndSubmitSample = () => {
		window.dispatchEvent(
			new window.CustomEvent(EVENT_SUBMIT_EXAMPLE, {detail: {}})
		)
	}
</script>
...
<div class="editor-header">
	...
	<div class="editor-header-item-full" />
	<div class="editor-header-item">
		<button
			class="editor-header-sample-button"
			on:click|preventDefault={genAndSubmitSample}
		>
			Sample HTML/CSS
		</button>
	</div>
